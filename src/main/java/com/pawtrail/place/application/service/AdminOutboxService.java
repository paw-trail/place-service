...
public class AdminOutboxService {
     ...
     * place.updated 는 식별자만 실어 보내고 search 가 그것으로 다시 읽으므로
     * 늦게 도착한 이벤트가 옛 값을 되살리지 않습니다.
     *
    ...
    public void republish(UUID outboxId) {
        ...
        if (!published) {
            ...
            throw new CustomException(PlaceErrorCode.OUTBOX_REPUBLISH_FAILED);
        }
