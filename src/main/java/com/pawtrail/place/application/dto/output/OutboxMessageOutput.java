 ...
 * 이 서비스가 내보내는 place.updated 는 식별자 하나뿐이라 그 걱정이 없습니다.
 * 그래도 담지 않는 것은 aggregateId 가 이미 같은 값이라 새로 알려 주는 것이 없고,
 * 관리자 화면이 다섯 서비스의 outbox 를 한곳에 모으므로 응답 모양이 같은 편이 낫기 때문입니다.
 ...
 * @param aggregateType 어느 종류의 집합체인지입니다. 이 서비스에서는 Place 하나뿐입니다.
